...
const CONTENT: Record<Lang, {
  ...
  ru: {
    capabilities: [
      { icon: Radar, title: "Онлайн-отслеживание", text: "GPS-координаты и контрольные точки на уровне сканирования для каждой перевозки." },
      { icon: Route, title: "Умная маршрутизация", text: "Маршруты планируются с учётом трафика, погоды, границ и дорожных работ." },
      { icon: Gauge, title: "Телематика автопарка", text: "Данные о скорости, топливе, температуре и стиле вождения каждого автомобиля." },
      { icon: Timer, title: "Прогноз ETA", text: "Расчётное время прибытия постоянно уточняется по мере продвижения груза." },
      { icon: FileCheck2, title: "Цифровые документы", text: "CMR, POD, температурные отчёты и таможенные документы в едином поисковом архиве." },
      { icon: LayoutGrid, title: "Операционная панель", text: "Все перевозки вашей программы — в одном операционном центре." },
    ],
    tower: [
      "Проблемы и исключения всегда выводятся наверх",
      "От уведомления до нужной перевозки — один клик",
      "KPI по своевременности, повреждениям и динамике затрат",
      "Отчёты можно экспортировать в вашу BI-систему",
    ],
    integrations: [
      { icon: Database, title: "Интеграция ERP / WMS", text: "Заказы передаются из вашей системы в нашу без повторного ручного ввода." },
      { icon: Plug, title: "Открытый API", text: "Данные по перевозкам, вебхуки отслеживания и документы доступны через REST API." },
      { icon: Smartphone, title: "Мобильный доступ", text: "Подтверждайте операции, подписывайте POD и проверяйте статус с любого устройства." },
      { icon: BellRing, title: "Проактивные уведомления", text: "Email, SMS или webhook-уведомления на каждом ключевом этапе." },
    ],
    securityTitle: "Безопасность и надёжность",
    security: [
      "Шифрование TLS при передаче и хранении данных",
      "Ролевой доступ для вашей команды",
      "Целевой показатель доступности — 99,9% с мониторингом",
      "Ваши данные остаются вашими и могут быть экспортированы в любое время",
    ],
    demoLink: "Запросить демонстрацию платформы",
  },
};
