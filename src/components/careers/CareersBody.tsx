...
const CONTENT: Record<Lang, {
  ...
  ru: {
    benefits: [
      { icon: Banknote, title: "Честная и прозрачная оплата", text: "Понятные диапазоны зарплат и оплата водителей с учётом плановых часов — без сюрпризов в конце месяца." },
      { icon: Plane, title: "Планируемый график", text: "Мы планируем вашу неделю так, чтобы вы могли планировать свою жизнь. Предсказуемые маршруты, фиксированное время." },
      { icon: GraduationCap, title: "Обучение за счёт компании", text: "CPC, ADR и обучение креплению груза оплачиваются компанией и проходят в рабочее время." },
      { icon: HeartPulse, title: "Здоровье и благополучие", text: "Частная медицинская страховка для водителей и их семей." },
      { icon: TrendingUp, title: "Реальные возможности роста", text: "От водителя к диспетчеру, от планировщика к руководителю сети." },
      { icon: ShieldCheck, title: "Современная техника", text: "Автомобили с телематикой, плановым обслуживанием и обязательной проверкой перед каждым выездом." },
    ],
    jobs: [],
    openBadge: "Открыта",
    lookingFor: "Где мы нанимаем сейчас",
    applyTitle: "Подать заявку за две минуты",
    applyText: "Никаких упражнений с идеальным сопроводительным письмом. Расскажите, кто вы и почему вам интересна позиция.",
    driverTitle: "Набор водителей — что мы обещаем",
    driverText: "Фиксированные коридорные маршруты, запланированное время дома, современная техника и оплата с учётом фактически отработанного времени.",
    tags: ["Категория CE", "Действующий CPC", "От 1 года дальних рейсов", "Без серьёзных нарушений"],
    applyNote1: "Подайте заявку через форму выше или напишите по электронной почте.",
    applyNote2: "",
  },
};
