...
const CONTENT: Record<Lang, {
  ...
  ru: {
    story: [
      "BRB Enterprise была создана на принципе, что бизнесу нужен логистический партнёр, а не просто перевозчик. Мы выстраиваем оптимальные маршруты, соединяющие компании и регионы.",
      "С момента основания мы выросли в логистическую компанию полного цикла, объединяющую перевозки, управление цепочками поставок и аналитические услуги.",
      "Технологии, на которых работает наша система — онлайн-отслеживание, интеллектуальная маршрутизация, телематика и цифровые документы — нужны для одной цели: чтобы согласованные сроки доставки выполнялись.",
    ],
    mission: "Сделать перевозки предсказуемыми. Для этого мы развиваем плотную сеть, работаем по подтверждённым расписаниям, измеряем результат каждой доставки.",
    vision: "Европа, в которой автомобильную логистику выбирают по уровню сервиса и оценивают по результату; где выражение «логистический партнёр» действительно означает партнёрство.",
    values: [
      { title: "Обязательство — это договорённость", text: "Если мы подтверждаем временное окно, мы его защищаем. Если выполнить его невозможно, вы узнаете об этом до того, как ситуация повлияет на вашу работу." },
      { title: "Безопасность важнее скорости", text: "Каждый автомобиль проверяется перед выездом, каждый водитель обучен креплению груза, а каждое отклонение разбирается." },
      { title: "Сеть — наш основной продукт", text: "Мы инвестируем в коридоры, хабы и телематику, а не в маркетинговые заявления." },
      { title: "Эффективность — это и устойчивость", text: "Меньше пустых километров, более точные маршруты и современная техника одновременно снижают затраты и выбросы." },
    ],
    ops: [
      { title: "Сначала планируем, затем контролируем", text: "До старта каждая перевозка планируется на основе данных по коридору, после чего операционный центр следит за ней 24/7." },
      { title: "Сначала измеряем, затем отчитываемся", text: "Своевременность, уровень повреждений и скорость реакции отслеживаются по каждому коридору и ежемесячно отражаются в отчётах." },
      { title: "Ответственность от начала до конца", text: "Один координатор ведёт перевозку от бронирования до подписанного POD. Без перебрасывания между отделами." },
    ],
    team: [
      { name: "Елена Варга", role: "Управляющий директор", note: "15 лет опыта в европейских автомобильных перевозках." },
      { name: "Йонас Келлер", role: "Руководитель операций", note: "Управляет операционным центром из Берлина. Считает расписание обещанием." },
      { name: "Прия Раман", role: "Коммерческий директор", note: "Разрабатывает логистические программы для среднего и крупного бизнеса." },
      { name: "Марек Новак", role: "Руководитель автопарка и безопасности", note: "Отвечает за готовность транспорта и обязательную проверку перед выездом." },
    ],
    safetyTitle: "Системная безопасность",
    safety: [
      "Проверка каждого автомобиля перед рейсом: шины, тормоза, температурное оборудование и средства крепления.",
      "Ежегодное обновление обучения водителей по креплению различных типов груза.",
      "Телематический контроль скорости и стиля вождения в каждом рейсе.",
      "Разбор каждого инцидента с анализом первопричины.",
      "Стандарты защитного вождения и управления усталостью на дальних маршрутах.",
    ],
    certs: [
      { title: "ISO 9001 — управление качеством", text: "Сертифицированные процессы качества в операционной деятельности." },
      { title: "Процессы GDP для фармацевтических грузов", text: "Температурные процедуры в соответствии с требованиями EU GDP." },
      { title: "Водители с подготовкой ADR", text: "Водители и сертифицированное оборудование для разрешённых маршрутов с опасными грузами." },
    ],
    credsNote: "Мы публикуем только те компетенции и документы, которые можем подтвердить.",
    ctaTitle: "Посмотрите, как мы работаем на вашем грузе",
    ctaText: "Расчёт, тестовая перевозка по одному направлению или полный анализ программы — самый быстрый способ оценить перевозчика.",
    ctaButton: "Запросить расчёт",
    numbers: [
      { value: "10 000+", label: "перевозок в год" },
      { value: "—", label: "целевой показатель доставки" },
      { value: "14", label: "собственных и управляемых хабов" },
      { value: "240+", label: "проверенных автомобилей" },
      { value: "30+", label: "обслуживаемых регионов" },
      { value: "24/7", label: "работа операционного центра" },
    ],
  },
};
