...
export function FleetExplorer() {
  ...
  return (
    <Container>
            ...
            <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-navy-100 bg-white shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-lift">
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="flex items-center justify-between">
                  <h2 className="font-display text-xl font-bold text-navy-900">{vehicle.name}</h2>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2 rounded-2xl bg-mist p-3 text-center">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs font-bold leading-tight text-navy-900">{vehicle.dimensions}</p>
                  </div>
                </div>

                <div className="mt-4">
                  <p className="text-xs font-bold uppercase tracking-wide text-slate">Ideal for</p>
                ...
                <ul className="mt-4 grid grid-cols-2 gap-x-3 gap-y-1.5">
                  {vehicle.features.map((f) => (
                    <li key={f} className="flex items-center gap-1.5 text-xs font-medium text-slate">
      ...
      {visible.length === 0 ? (
        <p className="mt-10 rounded-2xl border border-dashed border-navy-200 bg-mist p-8 text-center text-sm text-slate">
      ...
      {/* Maintenance note */}
      <Reveal delay={0.1}>
        <div className="mt-14 flex flex-col items-start justify-between gap-4 rounded-3xl border border-navy-100 bg-mist p-7 sm:flex-row sm:items-center">
